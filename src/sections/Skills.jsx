...
const skills = {
  ...
  AItools: [
    ...
    { name: "Cursor AI ", icon: <FaCubes className="text-blue-400" /> },
    { name: "Lovable.dev", icon: <FaLaptop className="text-blue-400" /> },
  ],
  Languages: [
  ...
  "IoT / Hardware": [
    ...
    { name: "ESP32", icon: <SiCplusplus className="text-sky-400" /> }, // alt icon
  ],
};
